...
# Load data from local files
    li_small = pd.read_csv("C:/Users/kangy/Downloads/AML Dataset/LI-Small_Trans.csv", header=0, parse_dates=[0])
    hi_small = pd.read_csv("C:/Users/kangy/Downloads/AML Dataset/HI-Small_Trans.csv", header=0, parse_dates=[0])
